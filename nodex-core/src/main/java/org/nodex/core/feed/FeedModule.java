...
/**
 * Dagger module for the feed feature.
 * Provides all feed-related dependencies.
 */
@Module
public class FeedModule {
    ...
    @Provides
    @Singleton
    FeedManager provideFeedManager(
        ...
        return new FeedManagerImpl(db, clientHelper, clientVersioningManager, 
