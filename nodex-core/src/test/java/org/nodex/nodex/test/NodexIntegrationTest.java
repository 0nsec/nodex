...
import org.nodex.core.test.BrambleIntegrationTest;
...
public abstract class NodexIntegrationTest<C extends NodexIntegrationTestComponent>
	...
	protected void setAutoDeleteTimer(NodexIntegrationTestComponent component,
	...
	protected void setMessageNotShared(NodexIntegrationTestComponent component,
			MessageId messageId) throws Exception {
		DatabaseComponent db = component.getDatabaseComponent();
		db.transaction(false, txn -> db.setMessageNotShared(txn, messageId));
	}
	protected void setMessageShared(NodexIntegrationTestComponent component,
			MessageId messageId) throws Exception {
		DatabaseComponent db = component.getDatabaseComponent();
