...
public class NodexRecyclerView extends FrameLayout {
	...
	public NodexRecyclerView(Context context) {
		this(context, null, 0);
	}
	public NodexRecyclerView(Context context, @Nullable AttributeSet attrs) {
	...
	public NodexRecyclerView(Context context, @Nullable AttributeSet attrs,
		...
		TypedArray attributes = context.obtainStyledAttributes(attrs,
				R.styleable.NodexRecyclerView);
		isScrollingToEnd = attributes
				.getBoolean(R.styleable.NodexRecyclerView_scrollToEnd, true);
		int drawableRes = attributes
				.getResourceId(R.styleable.NodexRecyclerView_emptyImage, -1);
		if (drawableRes != -1) setEmptyImage(drawableRes);
		String emtpyText =
				attributes.getString(R.styleable.NodexRecyclerView_emptyText);
		if (emtpyText != null) setEmptyText(emtpyText);
		String emtpyAction =
				attributes.getString(R.styleable.NodexRecyclerView_emptyAction);
	...
	private void initViews() {
		View v = LayoutInflater.from(getContext()).inflate(
				R.layout.nodex_recycler_view, this, true);
