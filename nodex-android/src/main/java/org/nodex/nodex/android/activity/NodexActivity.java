...
public abstract class NodexActivity extends BaseActivity {
	public static final String GROUP_ID = "nodex.GROUP_ID";
	public static final String GROUP_NAME = "nodex.GROUP_NAME";
	private static final Logger LOG =
			getLogger(NodexActivity.class.getName());
	@Inject
	NodexController briarController;
	@Deprecated
	@Inject
	...
	protected void showDozeDialog(@StringRes int message) {
		...
		b.setPositiveButton(R.string.fix,
				(dialog, which) -> {
					Intent i = getDozeWhitelistingIntent(NodexActivity.this);
					try {
